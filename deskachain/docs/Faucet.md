...
FAUCET_PRIV="$(./deskachain --datadir ./data/faucet_wallet wallet export --address "$FAUCET_ADDR" --show-private-key | awk '/private_key:/ {print $2}')"
./deskachain --datadir ./data/seed --network testnet init
./deskachain --datadir ./data/seed wallet import --private-key "$FAUCET_PRIV"
```
...
./deskachain --rpc-url http://<HOST_A_RPC_IP>:9311 faucet info
