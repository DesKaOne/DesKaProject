...
| Label | Purpose |
| ----- | ------- |
| `testnet-rc1` | Reports from the RC1 public testnet window. |
| `rc2-candidate` | Issue may need a fix before RC2 or wider public testnet. |
| `needs-repro` | Report needs exact steps, logs, or local reproduction. |
| `safety` | Public RPC exposure, secret handling, or release safety. |
| `p2p` | Peer reachability, sync, seed, or network identity. |
| `explorer` | Explorer API/UI/search/pagination. |
