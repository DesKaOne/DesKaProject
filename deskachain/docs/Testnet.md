# DesKaChain Controlled Testnet Runbook
...
go run ./node/cmd/deskachain --rpc-url http://127.0.0.1:8612 peer list --source
...
```powershell
go run ./node/cmd/deskachain --datadir ./testdata/tn3 dev reset --yes
go run ./node/cmd/deskachain --datadir ./testdata/tn3 --network testnet init
go run ./node/cmd/deskachain --datadir ./testdata/tn3 node start --rpc :8613 --p2p :9613 --advertise-p2p http://127.0.0.1:9613 --seed-file ./testdata/testnet-seeds.txt
```

Check peers:

```powershell
go run ./node/cmd/deskachain --rpc-url http://127.0.0.1:8613 peer list --source
go run ./node/cmd/deskachain --rpc-url http://127.0.0.1:8613 peer check http://127.0.0.1:9611
go run ./node/cmd/deskachain --rpc-url http://127.0.0.1:8613 peer sync http://127.0.0.1:9611
```
