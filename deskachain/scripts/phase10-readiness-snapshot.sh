...
grep -q 'Mainnet network ID.*TBD' "$root/docs/Phase10.1-Network-Identity-Genesis-Decision.md"
grep -q 'Mainnet chain ID.*TBD' "$root/docs/Phase10.1-Network-Identity-Genesis-Decision.md"
grep -q 'Genesis artifact.*TBD' "$root/docs/Phase10.1-Network-Identity-Genesis-Decision.md"
