...
func TestExplorerUIStaticRoutes(t *testing.T) {
	...
	for _, item := range []string{"dashboardSection", "dashboard-summary", "data-refresh=\"dashboard\"", "Last sync", "data-block-nav", "Previous block", "Next block", "tx-badge", "Status", "Type", "pagerHTML(\"asset\"", "selectLimit(\"asset\"", "Asset events"} {
