...
func TestCalculateChainStatsCoinbaseAndNormal(t *testing.T) {
	...
	coinbase := types.NewCoinbaseTransaction("dkc10000000000000000000000000000000000000000", config.InitialBlockReward, 1)
	...
	blocks := []types.Block{
		...
		{Height: 2, Hash: "b", PreviousHash: "a", Difficulty: config.InitialDifficulty, Transactions: []types.Transaction{types.NewCoinbaseTransaction("dkc10000000000000000000000000000000000000000", config.InitialBlockReward, 2), normal}},
	}
